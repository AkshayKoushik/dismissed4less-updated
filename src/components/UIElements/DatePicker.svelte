<script>
  ...
  import Month from "./date-picker/Month.svelte";
  import CelandarIcon from "../icons/CelandarIcon.svelte";
  import NavBar from "./date-picker/NavBar.svelte";
  import Popover from "./date-picker/Popover.svelte";
  import { getMonths } from "../../utils/helpers.js";
  import { formatDate, internationalize } from "timeUtils";
  import { keyCodes, keyCodesArray } from "../../utils/keyCodes.js";

  const dispatch = createEventDispatcher();
  const today = new Date();
  let popover;
  export let format = "#{m}/#{d}/#{Y}";
  export let start = today;
  ...
  export let buttonBorderColor = "#3f3f3f";
